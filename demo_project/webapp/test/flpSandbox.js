		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commaventicdemoproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commaventicdemoproject-display": {
								"semanticObject": "commaventicdemoproject",
								"action": "display",
								"description": "Demp Application",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.maventic.demoproject",
									"url": sap.ui.require.toUrl("com/maventic/demoproject")
								}
							}
						}
					}
